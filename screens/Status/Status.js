    ...
    return(
        ...
        style={styles.avatar}>
            ...
            {create ?
             ...
             <Image
             source={require('../Status/plus.jpg')}
...
export default class Status extends React.Component {
    render(){
        return(
           <SafeAreaView style={styles.rootStatus}>
               <TouchableOpacity>
               <ProfileCard
               create={true}
               title='My Status'
               ...
               create={false}
               title='John Doe'
               subTitle='Tuesday,06:40 PM'
               />
               <View style={styles.floating}>
               <View style={styles.create}>
                  <Image
                  source={require('../Status/edit.png')}
                  style={{width:25,height:25}}
                  />
               </View>
               <View style={styles.camera}>
                <Image
                source={require('../Status/camera.png')}
